...
For comparators, ZI-MLN without ![equation](https://www.codecogs.com/eqnedit.php?latex=\Lambda) is just removing the latent factor part. The simplified model takes less tie to implement and includes fewer parameters to estimate. 
